...
<div><h1 class="text-center">ACR Form Questions</h1></div>
...
// load the configuration file.
        ...
        $result = mysqli_query($conn,"SELECT * FROM acr_ques ORDER BY que_id");
        ...
        while($myrow = mysqli_fetch_array($result))
             {//begin of loop
               ...
               echo "<td align=center>"."<a href=\"edit_acr_ques.php?que_id=$myrow[que_id]\" class=\"btn btn-default \">edit</a> "."</td>";
               echo '</tr>';  
             }//end of loop
?>
</table>
