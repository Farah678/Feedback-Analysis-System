...
<div><h1 class="text-center">Update Peer Evaluation Form Questions</h1></div>
<?php
if(isset($_POST['Update']))
  {//begin of if($submit).
      // Set global variables to easier names
		...
		$result = mysqli_query($conn,"UPDATE feedback_ques_master SET ques='$title' , one_word='$one_word' WHERE q_id=$q_id ");		
    echo "<div class=\"col-md-10\"> <div class=\"alert alert-success text-center\" role=\"alert\"><b>Question has been updated Successfully!</b><br>You'll be redirected after (1) Seconds</div></div>";
